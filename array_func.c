/*
3.menu-driven program to insert, search, delete and sort elements in an array using functions (use only local variables)
@Farsan_Suneer
Date_of_completion: 13/07/2025
*/
#include<stdio.h>
int insertArray(int a[],int n)//function to insert elements to array
{
	int pos,e;
...
int deleteArray(int a[],int n)//function to delete from given position 
{
	int dpos,i;
...
void sortArray(int a[],int n)//function to sort array
{
	int i,j;
	int temp=0;
    for(i=0;i<n;i++)
...
void searchArray(int a[],int n)//function to search for elements in the array
{
	int i,e;
